...
import net.breezewere.service.OrderService;
...
public class OrderController {
    ...
    @GetMapping("/staff/{staff-id}/active-orders")
    ...
    @GetMapping("/staff/{staff-id}/received-order/{order-id}")
    ...
    @PutMapping("/staff/{staff-id}/order-prepared/{order-id}")
    ...
    @PutMapping("/staff/{staff-id}/pending-delivery/{order-id}")
    ...
    @PutMapping("/staff/{staff-id}/order-delivered/{order-id}")
    ...
    @GetMapping("/staff/{staff-id}/cancel-orders")
    ...
    @GetMapping("/staff/{staff-id}/cancel-order/{order-id}")
    ...
    @GetMapping("/staff/{staff-id}/completed-orders")
    ...
    @GetMapping("/staff/{staff-id}/completed-order/{order-id}")
